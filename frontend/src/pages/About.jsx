  ...
  return (
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-12 px-4 md:px-0">
        <img
          className="w-full md:max-w-[360px] self-start object-contain"
        ...
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600">
          ...
          <p>
            ...
            continiously strive to enhance ou platform. Integrating the latest
          ...
          <p>
            ...
            experience for every user. We aim to brige the gap between patients
